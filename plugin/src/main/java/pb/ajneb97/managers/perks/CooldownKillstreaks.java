...
public class CooldownKillstreaks {
    ...
    public void cooldownKillstreak(final PaintballPlayer jugador, final Partida partida, final String nombre, int tiempo) {
    ...
    public void cooldownParticulasFury(final PaintballPlayer jugador, final Partida partida) {
        this.jugador = jugador;
        this.partida = partida;
        BukkitScheduler scheduler = Bukkit.getServer().getScheduler();
        taskID = scheduler.scheduleSyncRepeatingTask(plugin, new Runnable() {
    ...
    public void cooldownNuke(final PaintballPlayer jugador, final Partida partida, final String[] separados1, final String[] separados2) {
        this.jugador = jugador;
        this.partida = partida;
        this.tiempo = 5;
