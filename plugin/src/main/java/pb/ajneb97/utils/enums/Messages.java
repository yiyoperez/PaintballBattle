...
public enum Messages {
    ...
    HELP_MESSAGE("MAIN.HELP"), NO_PERMISSION("NO_PERMISSION"), RELOADED("CONFIG_RELOADED"),
    ...
    GAME_SCOREBOARD_TITLE("GAME_SCOREBOARD_TITLE"),
    GAME_SCOREBOARD_BODY("GAME_SCOREBOARD_BODY"),
